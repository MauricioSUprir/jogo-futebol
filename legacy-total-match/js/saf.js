...
(function (global) {
  ...
  def("sem_parcelamento", "mercado", "season", 0.06, yes, function () { return "Não deixar parcelas de contratações VENCIDAS ao fim da temporada"; }, function (c) { var n = (TM.fin ? TM.fin.overdueList(c) : (c.installments || []).filter(function (i) { return (i.left || 0) > 0; })).length; return { ok: n === 0, why: n + " parcela(s) vencida(s) sem pagamento." }; });
  ...
  TM.saf = { tick: tick, seasonEnd: seasonEnd, card: card, onOfferRejected: onOfferRejected, onPlayerSold: onPlayerSold, onLoanTaken: onLoanTaken, onLeave: onLeave,
    clubSize: clubSize, offerChance: offerChance, CAT: CAT, EVENTS: EVENTS, makeOffer: makeOffer, accept: accept, reject: reject, migrate: migrate, clauseList: clauseList, breakSaf: breakSaf, sat: sat };
})(window);
