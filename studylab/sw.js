...
const ARQUIVOS = [
  ...
  './js/produto.js', './js/auth.js', './js/api.js', './js/fotos.js',
  ...
  './js/views/entrar.js', './js/views/escola.js', './js/views/planos.js', './js/views/pagamento.js', './js/views/criador.js', './js/views/termos.js',
];
